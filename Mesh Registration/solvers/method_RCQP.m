function [R,t,dstar,times,R0] = method_RCQP( correspondences, header,w )
% 
% w=ones(1,size(correspondences,2));
tic
% Compute equivalent compressed quadratic form

q = compress_quadData( correspondences,w );
...
[dstar,Z,G,lam] = solve_dual_template( q_margin, header );
% times.cvx = time_cvx;
tic
